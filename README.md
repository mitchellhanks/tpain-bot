...
Based on [Emilia](https://github.com/AyraHikari/EmiliaHikari)
...
<!-- TODO: Add instructions for creating a service -->
...
This file should be placed in your `TPBOT` folder, alongside the `__main__.py` file . 
...
```python
from TPBOT.default_config import Config
